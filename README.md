...
Le template `tf/cloud-init.yaml.tpl` installe les paquets, Krew et le plugin `kubectl node-shell`, active l'accès SSH par mot de passe, clone le dépôt dans `/home/cilium_lab`, puis lance `basic/00-build-foundation.sh`.
